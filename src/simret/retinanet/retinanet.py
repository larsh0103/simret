...
from . import detection_utils as det_utils
    ...
    def compute_loss(self, targets, head_outputs, matched_idxs):
        ...
        for targets_per_image, cls_logits_per_image, matched_idxs_per_image in zip(targets, cls_logits, matched_idxs):
            ...
            if matched_idxs_per_image.numel() == 0:
                ...
                gt_classes_target = torch.zeros_like(cls_logits_per_image)
                gt_classes_target[
                    foreground_idxs_per_image, targets_per_image["labels"][matched_idxs_per_image[foreground_idxs_per_image]],
                ] = 1
            ...
            loss = loss + sigmoid_focal_loss(
                cls_logits_per_image[valid_idxs_per_image], gt_classes_target[valid_idxs_per_image], reduction="sum",
...
class RetinaNetRegressionHead(nn.Module):
    ...
    def compute_loss(self, targets, head_outputs, anchors, matched_idxs):
        ...
        for (targets_per_image, bbox_regression_per_image, anchors_per_image, matched_idxs_per_image,) in zip(
            ...
            # compute the loss
            loss = loss + det_utils.smooth_l1_loss(bbox_regression_per_image, target_regression, size_average=False) / max(
                1, num_foreground
            )
...
class RetinaNet(nn.Module):
    ...
    def postprocess_detections(self, head_outputs, anchors, image_shapes):
        ...
        for (
            index,
            (box_regression_per_image, scores_per_image, labels_per_image, anchors_per_image, image_shape,),
        ) in enumerate(zip(box_regression, scores, labels, anchors, image_shapes)):
            ...
            for class_index in range(num_classes):
                ...
                boxes_per_class, scores_per_class, labels_per_class = (
                    ...
                    scores_per_image[inds, class_index],
                ...
                boxes_per_class, scores_per_class, labels_per_class = (
                    boxes_per_class[keep],
                    scores_per_class[keep],
                    labels_per_class[keep],
                )
...
model_urls = {
    "retinanet_resnet50_fpn_coco": "#TODO",
}
...
#         "resnet50", pretrained_backbone, extra_blocks=LastLevelP6P7(256, 256)
#     )
